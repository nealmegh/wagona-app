...
public class ArcProgress extends View {
    ...
    public void setData(float width, int fColor, int ufColor, int max) {

        this.strokeWidth = width;
        this.finishedStrokeColor = fColor;
        this.unfinishedStrokeColor = ufColor;
        this.max = max;
        this.invalidate();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (finishedSweepAngle == 0) finishedSweepAngle = 3;
