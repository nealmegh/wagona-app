 ...
 */
public class AssignmentHistoryActivity extends BaseActivity implements SearchView.OnQueryTextListener {
    ...
    AssignmentHistoryRecycleAdapter mHistoryRecycleAdapter = null;
    ...
    private void initControls() {
        ...
        textTakeTest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AssignmentHistoryActivity.this, HomeActivity.class);
        ...
        mHistoryRecycleAdapter = new AssignmentHistoryRecycleAdapter(this);
        recycleHistory.setAdapter(mHistoryRecycleAdapter);

        mHistoryRecycleAdapter.setOnItemClickListner(new AssignmentHistoryRecycleAdapter.OnItemClickListner() {
            @Override
            public void onItemClickListner(String testID) {
                Intent intent = new Intent(AssignmentHistoryActivity.this, AssignmentMarkTestActivity.class);
    ...
    private void showOnlyLocalHoistory() {
        ...
        Cursor mCursor = mDatabasehelper.getAllHistoryDataAssignment(managerWagona.getStringDetail(STUDENT_ID));

        if (mCursor != null) {
            if (mCursor.getCount() != 0 && mCursor.moveToFirst()) {
                do {
                    @SuppressLint("Range") TestHistoryBean mTestHistoryBean = gson.fromJson(mCursor.getString(mCursor.getColumnIndex(JSON_DATA)), TestHistoryBean.class);
        ...
        if (mTestHistoryBeans.size() != 0) {
            ...
            scrollViewHistory.setVisibility(View.GONE);
            showOkDialog(AssignmentHistoryActivity.this, "No History available");
        }
                ...
                try {
                    ...
                    if (mJsonObject.getInt("status") == 1) {
                        ...
                        for (int i = 0; i < mJsonArray.length(); i++) {
                            ...
                            mDatabasehelper.inserHistoryDataAssignment(managerWagona.getStringDetail(STUDENT_ID),mTestObject.getString("test_id"), mTestObject.toString());
                            // Gson gson = new GsonBuilder().create();
