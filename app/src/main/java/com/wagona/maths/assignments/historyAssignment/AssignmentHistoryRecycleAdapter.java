...
public class AssignmentHistoryRecycleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AssignmentHistoryRecycleAdapter(Context context){
