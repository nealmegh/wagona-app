 ...
 */
public class TestplayActivity extends BaseActivity implements CustomWebView.KeyListener {
    ...
    * */
    ...
    private void setScreenToolbar() {
        ...
        textHeader.setText(this.getIntent().getStringExtra("FORM"));
...
//    }
    ...
    private void callQuestionStuctureAPI(final String topic_list) {
        ...
        if (!preApiCallChecking())
            return;
        showProgressDialog("Loading...");

        StringRequest mStringRequest = new StringRequest(Request.Method.POST, getBaseUrl() + GET_QUESTION_STRUCTURE, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (mJsonObject.getInt(STATUS) == 1) {
                        ...
                        mQuestionsBeanList = (List<QuestionsBean>) gson.fromJson(new JSONObject(response).getJSONObject("topic_data").getString("questions"), listType);
                        ...
                        testID = new JSONObject(response).getJSONObject("topic_data").getString("id");
                        ...
                        showOkDialog(TestplayActivity.this, mJsonObject.getString(MESSAGE));
                    }
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(TOPIC_ID, topic_list);
    ...
    private void showRetryDialog(String error) {
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Retry", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        callQuestionStuctureAPI(TestplayActivity.this.getIntent().getStringExtra("TOPIC_LIST"));
    ...
    private void callMarkTestAPI() {
        ...
        StringRequest mStringRequest = new StringRequest(Request.Method.POST, getBaseUrl() + GENERATE_RESULT, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (mJsonObject.getBoolean("success")) {
                        ...
                        Intent intent = new Intent(TestplayActivity.this, MarkTestActivity.class);
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(SUBJECT_ID, TestplayActivity.this.getIntent().getStringExtra(SUBJECT_ID));
